...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_theme_uri('vegafoods/css/style.css'); ?>">
...
<body class="goto-here">
				...
				<div class="col-lg-12 d-block">
					<div class="row d-flex">
						<div class="col-md pr-4 d-flex topper align-items-center">
							...
							<span class="text">087854701779 wa</span>
						</div>
						<div class="col-md pr-4 d-flex topper align-items-center">
							<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
							<span class="text">christianse25@gmail.com</span>
						</div>
						<div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right">
							<span class="text">Service 24 jam kecuali kiamat</span>
						</div>
					</div>
				</div>
			</div>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco--light" id="ftco-navbar">
		<div class="container">

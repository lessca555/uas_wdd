                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <?php foreach ($banks as $bank => $data) : ?>
                                <input type="hidden" name="bank1" value="<?php echo $bank; ?>">
                                <input type="hidden" name="name1" value="<?php echo $data->name; ?>">
                                <input type="hidden" name="number1" value="<?php echo $data->number; ?>">
                            <?php endforeach; ?>
                            <?php else : ?>

            ...
            <div class="col-md-4">
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body p-0">
                      ...
                      <div class="alert alert-info m-2"><?php echo anchor('customer/payments/confirm', 'Proses Pembayaran'); ?></div>
                      <?php else : ?>
                        <table class="table table-hover table-striped table-hover">
                            <tr>
                                <td>Transfer</td>
                            ...
                            <tr>
                                ...
                                <td><b>
                                    ...
                                    ?>
                                    <?php echo $bank_data['transfer_to']; ?> a.n <?php echo $bank_data['name_s']; ?> (<?php echo $bank_data['number_s']; ?>)
                                </b></td>
                            </tr>
                            <tr>
                                <td>Transfer dari</td>
                                <td><b><?php echo $bank_data['bank']; ?> a.n <?php echo $bank_data['name']; ?> (<?php echo $bank_data['number']; ?>)</b></td>
                            </tr>
                        </table>
                      <?php endif; ?>
                    </div>
